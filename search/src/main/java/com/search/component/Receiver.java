...
public class Receiver {
	 ...
	 *                        searchComponent
	 *                        .updateInventory((String)fare.get("FLIGHT_NUMBER"
	 *                        ),(String)fare.get("FLIGHT_DATE"),(int)fare.get(
	 *                        "NEW_INVENTORY")); //call repository and update
	 *                        the fare for the given flight }
	 **/
